...
INVALID_PASSWORD = APIException(403, "Invalid email/password")
NOT_AUTHENTICATED = APIException(403, "Not authenticated")
...
OLD_PASSWORDS_DO_NOT_MATCH = APIException(422, "Old password do not match")
MlMOdel_NOT_FOUND = APIException(404, "Ml Models not found")
PARTNER_ALREDY_EXIST = APIException(409, "Partner already exists")